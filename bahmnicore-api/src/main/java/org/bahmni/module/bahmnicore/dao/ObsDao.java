...
public interface ObsDao {
    ...
    List<Obs> getObsByConceptsAndVisits(List<String> conceptNames, List<Integer> listOfVisitIds, ObsDaoImpl.OrderBy sortOrder, List<String> obsIgnoreList, Boolean filterOutOrderObs);
