...
public interface ObsDao {
    ...
    List<Obs> getObsByConceptAndVisits(String conceptName, List<Integer> listOfVisitIds, ObsDaoImpl.OrderBy sortOrder, List<String> obsIgnoreList, Boolean filterOutOrderObs);
